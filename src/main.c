...
/*   Updated: 2024/06/17 16:02:46 by disantam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	if (!data->textures[NO])
// 		return (1);
// 	data->textures[SO] = mlx_load_png(map->txtr[NO]);
// 	if (!data->textures[SO])
// 		return (1);
// 	data->textures[WE] = mlx_load_png(map->txtr[NO]);
// 	if (!data->textures[WE])
// 		return (1);
// 	data->textures[EA] = mlx_load_png(map->txtr[NO]);
// 	if (!data->textures[EA])
// 		return (1);
// 	return (0);
// }
...
{
	data->mlx = mlx_init(S_WIDTH, S_HEIGHT, "cuBit3D", 0);
	if (!data->mlx)
	{
